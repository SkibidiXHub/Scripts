...
local function NotificacaoNightMystic(titulo, mensagem)
    local success = pcall(function()
        ...
        local LogoID = "rbxassetid://78617112299549"
        local duration = 5
...
-- GỌI THỬ ĐỂ TEST:
-- ==========================================
NotificacaoNightMystic("Dojo Hub Loaded 🔔", "New Update v2.0🔥")
task.wait(0.8)
...
local v487 = v466:MakeTab({"Nhiệm Vụ/Vật Phẩm/V4", "swords"})
local v491 = v466:MakeTab({"Raid/Trái", "cherry"})
local v489 = v466:MakeTab({"Biển", "waves"})
local v497 = v466:MakeTab({"Stats", "Signal"})
local v493 = v466:MakeTab({"Dịch Chuyển", "locate"})
local v499 = v466:MakeTab({"Trạng Thái", "Scroll"})
local v494 = v466:MakeTab({"Hình Ảnh", "user"})
local v495 = v466:MakeTab({"Cửa Hàng", "shoppingCart"})
local v496 = v466:MakeTab({"Linh Tinh", "settings"})

v484:AddDiscordInvite({
    Name = "Dojo Hub | Community",
    Description = "Join server to next update new !",
    Logo = "rbxassetid://78617112299549",
    Invite = "https://discord.gg/dojo-hub"
})
