...
local v466 = vu32:MakeWindow({
    Title = "WaterMelon Hub [ BETA ] | Blox Fruits",
    SubTitle = "by realwatermelon",
    SaveFolder = "Redz | redz lib v5.lua"
})

v466:AddMinimizeButton({
    Button = { Image = "rbxassetid://97224029591833", BackgroundTransparency = 0 },
    Size = UDim2.new(0, 35, 0, 35),
    Corner = { CornerRadius = UDim.new(0.25, 0) },
})

local v484 = v466:MakeTab({"Tab | Discord", "info"})
local v485 = v466:MakeTab({"Tab | Settings", "settings"})
local v486 = v466:MakeTab({"Tab | Main Farm", "home"})
local v487 = v466:MakeTab({"Tab | Stack Farm", "swords"})
