...
local hasJoinedDiscord = "dojo_DiscordJoined.txt"

if not isfile(hasJoinedDiscord) then
    local discordInvite = "https://discord.gg/mcMEkVdJ"
    local inviteCode = "mcMEkVdJ"
