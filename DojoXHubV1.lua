...
Discord:AddDiscordInvite({
    Name = "Tiro Hub | Community",
    Description = "Link sẽ hết vào 11 ngày nữa !",
    Logo = "rbxassetid://89916401746",
    Invite = "https://discord.gg/MC9mcBk53"
})
spawn(function()
    pcall(function()
        while wait() do
