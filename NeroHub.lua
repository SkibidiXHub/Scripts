...
local v466 = loadstring(game:HttpGet("https://raw.githubusercontent.com/AnhDangNhoEm/UiRedz/refs/heads/main/RedzUiV.txt"))():MakeWindow({
    Title = "Nero Hub : Blox Fruits",
    SubTitle = "by real_Nero",
...
l_ImageButton_0.Image = "rbxassetid://125106574805976"
...
v484:AddDiscordInvite({
    Name = "nero Hub | Community",
    Description = "Discord Nero",
    Logo = "rbxassetid://11065772554174",
    Invite = "https://discord.gg/Nero-Hub"
})
...
local _ = v485:AddDropdown({
    Name = "Kích Thước Ui",
    Description = "Chọn kích thước ui",
...
local _ = v485:AddSection({"Valentines"})
v485:AddToggle({
    Name = "Auto Farm Quest",
    Description = "Tự động làm nhiệm vụ valentines",
    Default = false,
    Callback = function()
