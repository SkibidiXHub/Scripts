...
local v466 = vu32:MakeWindow({
    Title = "Dojo Hub [ BETA TESTING ] | Blox Fruits",
...
v484:AddDiscordInvite({
    ...
    Invite = "https://discord.gg/BnEDf6ktk"
})
...
local _ = v495:AddSection({"Join Server"})
v495:AddTextBox({
        Name = "Job ID",
...
local _ = v495:AddSection({"Settings"})
