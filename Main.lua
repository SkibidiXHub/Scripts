...
local v484 = v466:MakeTab({"Discord & Info", "info"})
...
v484:AddDiscordInvite({
    ...
    Description = "Join server to new update everyone !",
...
v485:AddToggle({
    ...
    Description = "Tự động đánh quái gần",
    Default = false,
...
v485:AddToggle({
    Name = "Auto Pirates",
    Description = "Tự động raid Pirate",
    Default = false,
...
v485:AddToggle({
    ...
    Description = "Tự động quái và boss",
    Default = false,
