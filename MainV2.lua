...
local v485 = v466:MakeTab({"Farming", "leaf"})
local v486 = v466:MakeTab({"Stack Farm", "swords"})
local v487 = v466:MakeTab({"Sea Event", "waves",
local v487 = v466:MakeTab({"Shop", "shoppingCart"})
local v488 = v466:MakeTab({"Misc & Sever", "settings"})

v484:AddDiscordInvite({
    Name = "Dojo Hub | Community",
    Description = "Join server to new update !",
    Logo = "rbxassetid://78617112299549",
    Invite = "https://discord.gg/Er72Mea1r"
})
...
v485:AddToggle({
    ...
    Description = "Tự động tiêu diệt kẻ địch gần",
    Default = false,
...
v485:AddToggle({
    ...
    Description = "Tự động farm boss xương",
    Default = false,
...
v485:AddToggle({
    ...
    Description = "Tự động tiêu diệt boss đã chọn",
    Default = false,
...
v485:AddDropdown({
    Name = "Material List",
    Description = "Rest danh sách nguyên liệu",
    Options = v664,
    Default = v664[1],
