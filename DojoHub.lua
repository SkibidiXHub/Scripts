...
Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/SkibidiXHub/ui-library/refs/heads/main/uibanana-library"))()
...
Library:Notify({
    Title = "UI Library By Obii",
    Description = "Chúc Chơi Vui Vẻ Và Thi Tốt",
    Duration = 3
})
...
SetAutoFarm:AddToggle("Lauguage", {
    Title = "Change Lauguage",
    Default = false,
    Callback = function(Value)
        _G.ChangeLauguage = Value
    end
})
