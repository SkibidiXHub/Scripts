...
local v15 = v14:CreateWindow({
    Title = "Dojo Hub [ Freemium ]",-- thay tên bạn muốn đặt
    SubTitle = "By skibidi",-- tên bạn
    TabWidth = 160,
    Theme = "Dark",--màu
    Acrylic = false,
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=78617112299549";
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("ko có tạo discord");
    end
});
