...
v484:AddDiscordInvite({
    ...
    Invite = "https://discord.gg/BnEDf68jwP"
})
...
v486:AddButton({Title = "Server Hop", Callback = function()
    Hop()
end})
...
v486:AddToggle({Title = "Infinite Geppo", Value = false, Callback = function(v1183)
    InfiniteGeppo = v1183
end})
spawn(function()
    while task.wait(1) do
